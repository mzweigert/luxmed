...
from api.luxmed.urls import HISTORY_VISITS_URL
from api.luxmed.urls import RESERVED_VISITS_URL
...
class LuxMedVisits:
    ...
    def _common_reservation_data(
            clinic_id: int, doctor_id: int, referral_id: int, room_id: int, service_id: int, start_date_time: Union[datetime, str],
    ...
    def find(self, city_id: int, service_id: int, language_id: int, payer_id: int,
             clinic_id: int = None, doctor_id: int = None, referral_id: int = None,
        ...
        Args:
            ...
            referral_id (int, optional): Show also appointments for referrals.
